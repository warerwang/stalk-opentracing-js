...
/**
 * Converts spans into zepkin-compatible json format and reports to
 ...
 * just pass built-in `window.fetch` function. If you're in node.js, you need to
 * bring your own fetch, check `node-fetch` package.
 */
